...
echo "$(date) $line "  "Seeding best times table with ONE stops as origins"
mysql <./sql_scripts/insert_first_record_ONE.sql -u mbta_ontime mbta_data -t -vvv >> ./data/setup.log
