...
mysql <../sql_scripts/weekend_stop_pairs.sql -u mbta_ontime mbta_data -t -vvv >> ../data/setup.log
echo "$(date) $line "  "Creating temp table with previous stops for all trip pairs."
mysql <../sql_scripts/weekend_route_pair_counts.sql -u mbta_ontime mbta_data -t -vvv >> ../data/setup.log
...
# Copyright 2013 by Douglas R. Tillberg <doug@transitboston.com>.  This file is part of the mbta_map project. 
# It is subject to the license terms in the LICENSE file found in the top-level directory of this distribution 
# and at https://github.com/doug0/mbta_mapblob/master/LICENSE. No part of the mbta_maps project, including this file, 
# may be copied, modified, propagated, or distributed except according to the terms contained in the LICENSE file.
